...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/05 03:58:14 by zanejar           #+#    #+#             */
/*   Updated: 2023/06/05 03:58:15 by zanejar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	textures_init(t_data *data)
{
	...
	data->door_path = mlx_xpm_file_to_image(data->mlx_ptr, data->door_path, \
	&data->parsing->i, &data->parsing->j);
	...
	&data->texture[4].bits_per_pixel, &data->texture[4].line_length, \
