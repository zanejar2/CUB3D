...
/*   Updated: 2023/06/05 02:17:35 by zanejar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	horizontal_intersection(t_data *data, int i)
{
	...
	data->ray[i].x_intercept = data->player.x \
	+ (data->ray[i].y_intercept - data->player.y) / tan(data->ray[i].ray_angle);
...
int	vertical_intersection(t_data *data, int i)
{
	...
	* data->tile_size;
	...
	data->ray[i].y_intercept = data->player.y \
	+ (data->ray[i].x_intercept - data->player.x) * tan(data->ray[i].ray_angle);
